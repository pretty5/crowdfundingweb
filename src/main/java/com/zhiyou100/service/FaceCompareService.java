...
public class FaceCompareService {
    static final String ak_id = "LTAIyrDJ8IbGvsln"; //用户ak
    static final String ak_secret = "hnSMoKj41dhGZd64WVmXmN3G3Iv2wc"; // 用户ak_secret
    static final String url = "https://dtplus-cn-shanghai.data.aliyuncs.com/face/verify";
    static final double limit=80.0;


    public boolean compare(String url1, String url2) throws CrowdFundingException {
        ...
        try {
            ...
            //将json字符串 转为  map  或者 json对象
            JsonParser parser = new JsonParser();
            JsonObject jsonObj = parser.parse(jsonResult).getAsJsonObject();
            double confidence = jsonObj.get("confidence").getAsDouble();
            ...
            throw new CrowdFundingException(2,"图片识别失败");
        }
    ...
    public static void main(String[] args) throws Exception {
      ...
      */
        ...
        String url2="https://crowdfundingweb.oss-cn-beijing.aliyuncs.com/cxc1.png";
        new FaceCompareService().compare(url1,url2);
